package rachieru.colteanu.bosschet.ui.base;
...
import rachieru.colteanu.bosschet.utils.ShapeCreator;
...
public abstract class BodyHolder {
    ...
    public BodyHolder(Vector2 position, Vector2 size, final BodyDef.BodyType type, final World world, float density, final boolean sensor) {
        mBody = ShapeCreator.createRectangle(position, size, type, world, density, sensor);
    }
